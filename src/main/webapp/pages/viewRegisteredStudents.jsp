              ...
              <a class="list-group-item active main-color-bg">
               ...
               <span class="fas fa-user-clock" aria-hidden="true"></span>
                ...
                <div class="collapse" id="menu11">
                    ...
                    <a href="viewAttendance" class="list-group-item" data-parent="#menu11">Modify Attendance</a>
                </div>
            ...
            <!-- Website Overview -->
              ...
              <div class="panel-body">
                  <div class="row">
                      ...
                      <div class="col-md-4">
                          <form action = "serachStudent" method="get">
                              <input type="text" class ="form-control" name="search" placeholder="Search By Student Name">
                          </form>
                      </div>
                      <div class="col-md-4 text-right">
                          <a href="dash" class="btn btn-primary">New Registration</a>
                      </div>
                  </div>
