                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <form action="searchAttendance" method="get">
                                        <input type="text" class="form-control" name="search" placeholder="Search By Student Registration Number">
                                    </form>
                                </div>
                                <div class="col-md-4 text-right">
                                    <a href="addAttendancePage" class="btn btn-primary">New Record</a>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <c:forEach items="${studentAttendances}" var="attendance">
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <div>
                                            <a href='deleteAttendance?id=${attendance.id}'
